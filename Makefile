...
push:
	docker push ${DOCKER_USER}/lucas-lehmer-go-server:latest
        docker push ${DOCKER_USER}/lucas-lehmer-scala-server:latest
        docker push ${DOCKER_USER}/lucas-lehmer-python-server:latest
start:
